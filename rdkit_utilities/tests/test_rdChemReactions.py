...
def test_run_click():
    ...
    reacts = (
        Chem.MolFromSmarts(cooh, orderByMapNumber=True, clearAtomMapNumbers=True, asQueryAtoms=False),
        Chem.MolFromSmarts(cnc, orderByMapNumber=True, clearAtomMapNumbers=True, asQueryAtoms=False)
    )
...
def test_CleanReaction():
    ...
    reactant2 = Chem.MolFromSmarts("[C:1](-[H:2])(-[H:3])(-[H:4])-[N:5](-[H:6])-[C:7](-[H:8])(-[H:9])(-[H:10])")
